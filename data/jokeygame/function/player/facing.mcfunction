...
execute if entity @s[x_rotation=-90..-50] run scoreboard players set pitch_facing int -1
execute if entity @s[x_rotation=50..90] run scoreboard players set pitch_facing int 1
execute if entity @s[x_rotation=-50..50] run scoreboard players set pitch_facing int 0