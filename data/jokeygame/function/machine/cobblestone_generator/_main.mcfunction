...
execute if entity @s[tag=!stone_machine_jk] positioned ^ ^ ^1 if block ~ ~ ~ #air run setblock ~ ~ ~ cobblestone
execute if entity @s[tag=stone_machine_jk] positioned ^ ^ ^1 if block ~ ~ ~ #air run setblock ~ ~ ~ stone
