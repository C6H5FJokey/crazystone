...
# 长竹机的item_display构造
setblock ~ ~ ~ barrier
data merge entity @s {item: {count: 1, id:"minecraft:dispenser"}, Tags:["machine_jk", "bamboo_generator_jk"],\
...
# 设置竹子插槽，设置在出口对应面
execute if score pitch_facing int matches 0 if score yaw_facing int matches 0 run scoreboard players set facing int 3
execute if score pitch_facing int matches 0 if score yaw_facing int matches 1 run scoreboard players set facing int 4
execute if score pitch_facing int matches 0 if score yaw_facing int matches 2 run scoreboard players set facing int 2
execute if score pitch_facing int matches 0 if score yaw_facing int matches 3 run scoreboard players set facing int 5
execute if score pitch_facing int matches 1 run scoreboard players set facing int 0
execute if score pitch_facing int matches 2 run scoreboard players set facing int 1
scoreboard players operation slot_init type_id_jk = bamboo_slot type_id_jk
scoreboard players set invisible int 1
execute at @s positioned ^ ^ ^1 run function jokeygame:slot/init_interface
# 设置触发功能需要的tick
