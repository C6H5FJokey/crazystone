...
# 游戏主要逻辑
execute if score game_state machine_tick_jk = ready_state machine_tick_jk run function jokeygame:_ready_state
execute if score game_state machine_tick_jk = main_state machine_tick_jk run function jokeygame:_main_state
# 获取玩家人数
